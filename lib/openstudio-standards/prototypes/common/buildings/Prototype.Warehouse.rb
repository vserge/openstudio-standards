...
module Warehouse
  ...
  def model_custom_geometry_tweaks(model, building_type, climate_zone, prototype_input)
    ...
    OpenStudio.logFree(OpenStudio::Info, 'openstudio.prototype.Warehouse', 'Adding skylights.')
    case template
      when '90.1-2010', '90.1-2013', '90.1-2016', '90.1-2019'
        case climate_zone
          when 'ASHRAE 169-2006-6A',
               ...
               'ASHRAE 169-2013-7A',
               'ASHRAE 169-2013-8A'
            model_add_skylights(model, 'geometry/ASHRAEWarehouse2004Skylights.osm')
          else
            model_add_skylights(model, 'geometry/ASHRAEWarehouse2010Skylights.osm')
        end
      else
        model_add_skylights(model, 'geometry/ASHRAEWarehouse2004Skylights.osm')
    end
